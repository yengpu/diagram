...
static constexpr auto qt_meta_stringdata_CLASSDiagramTextItemENDCLASS = QtMocHelpers::stringData(
    "DiagramTextItem",
    "lostFocus",
    "",
    "DiagramTextItem*",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSDiagramTextItemENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSDiagramTextItemENDCLASS_t qt_meta_stringdata_CLASSDiagramTextItemENDCLASS = {
    {
